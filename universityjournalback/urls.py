...
from .views import add_discipline, add_group, delete_discipline, delete_group, get_attendance, add_session, delete_session, get_groups_list, get_student_list, get_students_by_group, update_discipline, update_group
from .views import get_teacher_list, delete_user, update_user, update_attendance, update_session, get_discipline_list, update_teacher_disciplines
...
urlpatterns = [
    ...
    path('api/get_courses_list/', get_discipline_list),
